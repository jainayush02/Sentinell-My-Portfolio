        ...
        <div className="max-w-7xl mx-auto px-0.5 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-2xl tracking-[0.2em] font-black bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-fuchsia-600 leading-none uppercase" style={{ fontFamily: "'Anta', sans-serif" }}>Sentinal</span>
          ...
          <>
            ...
            >
              <div className="flex justify-between items-center mb-10">
                <span className="text-lg font-black bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-fuchsia-600 tracking-tight" style={{ fontFamily: "'Anta', sans-serif" }}>Sentinal</span>
