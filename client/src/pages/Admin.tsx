    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-slate-500 font-medium font-sans">Handshaking with Server...</p>
        </div>
      </div>
    );
  }
        ...
        <Card className="w-full max-w-md bg-white border-slate-200 shadow-2xl shadow-blue-500/10 relative z-10 rounded-[2rem] overflow-hidden">
          <CardHeader className="text-center pt-8 pb-4">
            <div className="mx-auto w-64 h-64 flex items-center justify-center mb-1">
              <img src="/admin-logo.png" alt="Sentinel Logo" className="w-full h-full object-contain drop-shadow-2xl brightness-110" />
            </div>
            <CardTitle className="text-3xl font-heading font-medium tracking-tight text-slate-900">Sentinel Gateway</CardTitle>
    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-white border-b border-slate-200 sticky top-0 z-[50]">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-bold text-sm tracking-tighter uppercase">Sentinel <span className="text-blue-600">Admin</span></span>
        </div>
        ...
        {isSidebarOpen && (
          ...
          >
            <div className="p-8">
              ...
              <h1 className="text-sm font-black tracking-tight" style={{ fontFamily: "'Anta', sans-serif" }}>Sentinal <span className="text-blue-600 italic block text-[9px] tracking-widest font-sans">Admin Nexus</span></h1>
            </div>
      ...
      <div className="hidden md:flex items-center justify-between px-12 py-4 bg-white border-b border-slate-100 sticky top-0 z-[40] shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-black tracking-widest uppercase" style={{ fontFamily: "'Anta', sans-serif" }}>Sentinal <span className="text-blue-600 font-sans tracking-normal font-black">Admin</span></h1>
